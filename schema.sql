...
INSERT IGNORE INTO competences (nom, categorie) VALUES
    ...
    ('SGBD et language SQL',                                        'Base de donnees'),
    ('Bases de donnees et algebres relationnnelles',                'Base de donnees'),
    ('Recherche operationnelle',                                       'Informatique'),
    ('Theorie des graphes',                                            'Informatique'),
    ('Projet integrateur',                                             'Informatique'),
    ('Architecture et topologie des reseaux',                              'Systemes'),
    ('Utilisation et administration sous windows et linux',                'Systemes'),
    ('Outils de base en informatique',                                 'informatique'),
    ('Algorithmes',                                                        'Systemes'),
    ('language C',                                                         'Systemes'),
    ('Administration des reseaux sous windows et linux',                   'Systemes'),
    ('probabilites',                                   ' mathematiques fondamentales'),
    ('Statistique inferentielles',                      'mathematiques fondamentales'),
    ('Analyse et application',                          'Mathematiques fondamentales'),
    ('Algebre lineaire',                                'mathematiques fondamentales'),
    ('logiques arithmetiques',                          'mathematiques fondamentales'),
    ('equations differentielles',                       'mathematiques fondamentales'),
    ('Suite et series numeriques',                      'Mathematiques fondamentales'),
    ('Anglais technique',                                          'culture generale'),
    ('Deontologie',                                                'culture generale'),
    ('TEEO',                                                       'culture generale');
